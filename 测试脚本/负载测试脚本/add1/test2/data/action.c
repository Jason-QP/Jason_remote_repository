Action()
{
	...
	web_add_cookie("gougutab={\"tab_id\":\"32\",\"tab_array\":[{\"id\":\"32\",\"url\":\"/home/cate/flow_type\",\"title\":\"ÂÆ°ÊâπÁ±ªÂûã\"}]}; DOMAIN=192.168.129.196");
	...
	web_custom_request("v2", 
		...
		"Body=\tvÑß¶FÍø‘ù\n\b€ƒá¨120.0.6099.129-64≥˛˚\"zh-CN*\n\nWindows NT\n10.0.190452f\nx86_64⁄]ÄÄ»ÄÓˇ\"80WA(0¿8ÑB\n\b", 
		LAST);
	...
	web_custom_request("v2_6", 
		...
		"Mode=HTML", 
		"EncType=application/vnd.chrome.uma", 
		"Body=\tvÑß¶FÍø”ª\b€ƒá¨120.0.6099.129-64≥˛˚\"zh-CN*\n\nWindows NT\n10.0.190452ü\nx86_64⁄]ÄÄ»ÄÓˇ\"80WA(0¿8ÑBê\bÜÅõ≤\r21.20.16.46272Google Inc. (Intel):bANGLE (Intel, Intel(R) HD Graphics 630 (0x0000591B) Direct3D11 vs_5_0 ps_5_0, D3D11-21.20.16.4627)MqGÏBU%‰ÏBe", 
		LAST);
